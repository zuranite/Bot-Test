...
client.on(Events.InteractionCreate, async interaction => {
	...
	try {
		...
		if (interaction.replied || interaction.deferred) {
			await interaction.editReply({ content: 'There was an issue while executing this command!', flags: MessageFlags.Ephemeral });
		} else {
			await interaction.reply({ content: 'There was an issue while executing this command!', flags: MessageFlags.Ephemeral });
		}
	}
});
